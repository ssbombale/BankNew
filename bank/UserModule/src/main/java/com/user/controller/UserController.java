...
public class UserController {
	...
	@PutMapping("User/applyLoan/{id}")
	public ResponseEntity<CustomeLoanApply> updateCustomerLoan(@PathVariable Integer id,@RequestBody CustomeLoanApply customerLoan)
	
	{
		System.out.println(id);
		ResponseEntity<CustomeLoanApply> responseEntity = new ResponseEntity<>(HttpStatus.OK);
		customerService.updateCustomerLoan(customerLoan, id);
